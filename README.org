...
It's under development and  highly experimental, should be used for testing only.

*Smart Mode* combines *Indent Mode* and *Paren Mode* since parinfer v3.0.
`parinfer-smart.el` provide `Smart Mode` implementation.
This is *NOT* compatible with the old `parinfer-mode`.
